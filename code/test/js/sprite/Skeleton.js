class Skeleton {
	constructor() {
		let columnCount = 9;//9 colonnes sur img
		let rowCount = 4;//4lignes
		...
		document.querySelector("#game").append(this.node);//ajoute le dans le noeud

		this.tiledImage = new TiledImage("images/skeleton-walk.png", columnCount, rowCount, refreshDelay, loopColumns, scale, this.node);
		this.tiledImage.changeRow(9);//si elle est en commentaire mon squellette apparait de dos
